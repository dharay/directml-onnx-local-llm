...
class Model:
    ...
    def make_model(self, input_path):
        ...
        if input_path.endswith(".gguf"):
            ...
            model = GGUFModel.from_pretrained("Gemma3ForCausalLM", input_path, self.head_size, self.hidden_size, self.intermediate_size, self.num_attn_heads, self.num_kv_heads, self.vocab_size)
...
def create_model(model_name, input_path, output_dir, precision, execution_provider, cache_dir, **extra_options):
    ...
    config.final_logit_softcapping = 30
